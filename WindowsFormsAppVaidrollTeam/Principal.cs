...
using Capa_Entidad;
using Capa_Negocio;
using WindowsFormsAppVaidrollTeam.DAOModels;
...
namespace WindowsFormsAppVaidrollTeam
{
    public partial class Principal : Form
    {
        ...
        {
            NotificacionesDAO notificaciones = new NotificacionesDAO();

            List<Notificaciones> notificaciones1 = notificaciones.ObtenerNotificaciones();

            if (notificaciones1!= null && notificaciones1.Count> 0)
            {
                foreach(var notificacion in notificaciones1) {

                    MessageBox.Show(notificacion.nombre + " " + notificacion.descripcion);
                }
            }
        }
